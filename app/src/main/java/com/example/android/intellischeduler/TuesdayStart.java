...
public class TuesdayStart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("Tuesday Slots \n\n\n");
        ...
        time_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(TuesdayStart.this,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.navigation_done:
                startActivity(new Intent(getApplicationContext(),WednesdayStart.class));
                return true;
            default:
