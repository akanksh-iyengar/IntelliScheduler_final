...
public class ThursdayStart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("Thursday slots \n\n\n");
        ...
        time_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(ThursdayStart.this,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.navigation_done:
                startActivity(new Intent(getApplicationContext(),FridayStart.class));
                return true;
            default:
