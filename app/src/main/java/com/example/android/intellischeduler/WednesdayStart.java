...
public class WednesdayStart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("Wednesday slots \n\n\n");
        ...
        time_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(WednesdayStart.this,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.navigation_done:
                startActivity(new Intent(getApplicationContext(),ThursdayStart.class));
                return true;
            default:
